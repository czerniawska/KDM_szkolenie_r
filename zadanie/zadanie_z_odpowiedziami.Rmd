...
demo <- read_csv("zadanie/dane/demografia.csv")
legenda <- read_csv("zadanie/dane/legenda_grup.csv")
...
```r
raw_wyniki <- read_csv("zadanie/dane/wyniki_pamieci.csv")
...
# Zapisywanie
ggsave("zadanie/wyniki/moj_wykres.png", plot = wykres)
```
...
tabela1 %>% 
  as_flex_table() %>% 
  save_as_docx(path = "zadanie/wyniki/tabela1.docx")
```
